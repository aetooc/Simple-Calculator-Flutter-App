        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                calbutton('AC', Color.fromARGB(255, 3, 204, 244), Colors.white),
                calbutton('+/-', Color.fromARGB(255, 3, 204, 244), Colors.white),
                calbutton('%', Color.fromARGB(255, 3, 204, 244), Colors.white),
                calbutton('/', Color.fromARGB(255, 1, 93, 252), Colors.white),
              ],
            ),
            SizedBox(
              height: 10,
            ...
            Row(
              ...
              children: [
                ...
                calbutton('x', Color.fromARGB(255, 1, 93, 252), Colors.white),
              ],
            ),
            SizedBox(
              height: 10,
            ...
            Row(
              ...
              children: [
                ...
                calbutton('.', Color.fromRGBO(48, 48, 48, 1), Colors.white),
                calbutton('=', Color.fromARGB(255, 1, 93, 252), Colors.white),
              ],
            )
          ],
